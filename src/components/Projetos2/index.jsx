...
import img6 from '../../assets/DevCardapio.png'
...
export function Projects() {
    ...
    const texts = {
        'pt-BR': {
            ...
            introductionProject6: "Site simples e objetivo, onde o usuário pode adicionar e remover itens pro carrinho, e finalizar seu pedido enviando os dados do produto via whatsapp.",
            button: "Código"
        },
        'en-US': {
            ...
            introductionProject6: "Simple and objective website, where the user can add and remove items to the cart, and finalize their order by sending product details via WhatsApp.",
            button: "Code"
        }
    };
            ...
            <Bounce>
                ...
                <Projetos>
                    ...
                    <div className='container-projects'>
                        ...
                        <div className='buttons'>
                            <a target="_blank" href="https://dev-cardapio.netlify.app/">
                                <button className='btn-site'><TbWorldWww /> Site</button>
                            </a>
                            <a target="_blank" href="https://github.com/BrendonOlivier/Cardapio-Online">
                                <button className='btn-code'><PiTreeViewDuotone /> {texts[language].button}</button>
                            </a>
                        </div>
                    </div>
